...
// Motoren
String getM1Richtung() {
  return String(M1Richtung); }

String setM1Richtung(String value) {
  M1Richtung = value.toInt();
  return value; }

String getM1speed() {
  return String(M1speed); }

String setM1speed(String value) {
  M1speed = value.toInt();
  return value; }

String getM2Richtung() {
  return String(M2Richtung); }

String setM2Richtung(String value) {
  M2Richtung = value.toInt(); 
  return value; }

String getM2speed() {
  return String(M2speed); }

String setM2speed(String value) {
  M2speed = value.toInt();
  return value; }
// Motoren
...
FieldList fields = {
  ...
  { "solidColor",         "Color",             ColorFieldType,      0,          255,  getSolidColor,       NULL,         setSolidColor       },
    ...
    {"MLlr",              "L links--rechts",   NumberFieldType,     0,           10,  getM1Richtung,       NULL,         setM1Richtung },// für Motore 
    {"M1speed",           "M1 Speed",          NumberFieldType,     0,          255,  getM1speed,          NULL,         setM1speed}, 
    {"M2lr",              "R links--rechts",   NumberFieldType,     0,           10,  getM2Richtung,       NULL,         setM2Richtung},
    {"M2speed",           "M2 Speed",          NumberFieldType,     0,          255,  getM2speed,          NULL,         setM2speed},
